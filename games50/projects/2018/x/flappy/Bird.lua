...
--NOTE: Setting GRAVITY to 20 was too large on my machine
...
function Bird:update(dt)
    self.dy = self.dy + GAME_GRAVITY * dt

    -- burst of anti-gravity when space or left mouse are pressed
    if love.keyboard.wasPressed('space') or love.mouse.wasPressed(1) then
        -- NOTE: Setting self.dy to 5 adjusted the bird by too large on my machine
        self.dy = GAME_ANTI_GRAVITY
        sounds['jump']:play()
    end
