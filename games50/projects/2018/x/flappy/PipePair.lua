...
-- ASSIGNMENT: no longer set specific value for vertical gap
--local GAP_HEIGHT = 90
...
function PipePair:init(y)
    ...
    self.pipes = {
        ...
        -- ASSIGNMENT: set the gap between pipes to a random number
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + math.random(80, 140))
    }
